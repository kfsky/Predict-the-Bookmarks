...
def get_umap_story(input_df):
    col_prefix = "story"
    if len(input_df) == 40000:
        titles = np.load("../add_data/train_story_roberta.npy")
    else:
        titles = np.load("../add_data/test_story_roberta.npy")
...
def get_umap_keyword(input_df):
    col_prefix = "keyword"
    if len(input_df) == 40000:
        titles = np.load("../add_data/train_keyword_roberta.npy")
    else:
        titles = np.load("../add_data/test_keyword_roberta.npy")
