    ...
    def fit(self, input_df, y=None):
        ...
        if self.decomposition == "svd":
            ...
            if self.column == "story" or self.column == "title_story":
                self.pipeline_ = Pipeline([
                    ("tfidf", TfidfVectorizer(tokenizer=mecab_tokenizer, max_features=10000)),
                    ("PCA", PCA(n_components=50, random_state=71))
                ])
            else:
                self.pipeline_ = Pipeline([
                    ("tfidf", TfidfVectorizer(tokenizer=mecab_tokenizer_title_keyword, max_features=10000)),
...
def main():
    ...
    process_blocks = [
        ...
        *[TfidfBlock(c, decomposition="PCA") for c in [
            "keyword",
            "title",
            "story",
            "title_story"
        ...
        *[BM25Block(c, decomposition="PCA") for c in [
            "keyword",
            "title",
        ]],
        ...
        *[CountVectorizerBlock(c, decomposition="PCA") for c in [
            "keyword",
            "title",
            "story"
        ]],
